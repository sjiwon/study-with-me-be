...
public enum StudyParticipantErrorCode implements ErrorCode {
    ...
    ALREADY_LEAVE_OR_GRADUATED(HttpStatus.CONFLICT, "STUDY_PARTICIPANT_004", "참여 취소 또는 졸업한 스터디는 다시 참여 신청할 수 없습니다."),
    APPLIER_NOT_FOUND(HttpStatus.NOT_FOUND, "STUDY_PARTICIPANT_005", "신청자 정보를 찾을 수 없습니다."),
    STUDY_IS_TERMINATED(HttpStatus.CONFLICT, "STUDY_PARTICIPANT_006", "스터디가 종료되었습니다."),
    ...
    HOST_CANNOT_LEAVE_STUDY(HttpStatus.BAD_REQUEST, "STUDY_PARTICIPANT_010", "스터디 팀장은 팀장 권한을 위임하고 스터디에서 떠날 수 있습니다."),
