...
public enum StudyParticipantErrorCode implements ErrorCode {
    ...
    STUDY_IS_TERMINATED(CONFLICT, "STUDY_PARTICIPANT_006", "종료된 스터디에 대해서는 작업을 수행할 수 없습니다."),
    STUDY_CAPACITY_ALREADY_FULL(CONFLICT, "STUDY_PARTICIPANT_007", "스터디 정원이 꽉 찼습니다."),
    SELF_DELEGATING_NOT_ALLOWED(CONFLICT, "STUDY_PARTICIPANT_008", "새로운 스터디 팀장은 자기자신이 아닌 다른 참여자를 선택해주세요."),
