...
import static com.kgu.studywithme.global.filter.MdcKey.REQUEST_ID;
import static com.kgu.studywithme.global.filter.MdcKey.REQUEST_IP;
import static com.kgu.studywithme.global.filter.MdcKey.REQUEST_METHOD;
import static com.kgu.studywithme.global.filter.MdcKey.REQUEST_PARAMS;
import static com.kgu.studywithme.global.filter.MdcKey.REQUEST_TIME;
import static com.kgu.studywithme.global.filter.MdcKey.REQUEST_URI;
import static com.kgu.studywithme.global.filter.MdcKey.START_TIME_MILLIS;
import static com.kgu.studywithme.global.log.RequestMetadataExtractor.getClientIP;
import static com.kgu.studywithme.global.log.RequestMetadataExtractor.getHttpMethod;
import static com.kgu.studywithme.global.log.RequestMetadataExtractor.getRequestUriWithQueryString;
import static com.kgu.studywithme.global.log.RequestMetadataExtractor.getSeveralParamsViaParsing;
