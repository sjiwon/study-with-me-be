...
public class StudySearchApiController {
    ...
    @GetMapping
    public ResponseEntity<SliceResponse<List<StudyPreview>>> getStudiesByCategory(
        ...
        final SliceResponse<List<StudyPreview>> response = studySearchUseCase.getStudiesByCategory(
                new GetStudiesByCategory(condition, request.page())
        );
    ...
    public ResponseEntity<SliceResponse<List<StudyPreview>>> getStudiesByRecommend(
        ...
        final SliceResponse<List<StudyPreview>> response = studySearchUseCase.getStudiesByRecommend(
                new GetStudiesByRecommend(condition, request.page())
        );
        return ResponseEntity.ok(response);
    }
}
