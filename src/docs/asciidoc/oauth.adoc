...
include::{snippets}/OAuthApi/Access/query-parameters.adoc[]
...
include::{snippets}/OAuthApi/Login/Failure/query-parameters.adoc[]
...
include::{snippets}/OAuthApi/Login/Success/query-parameters.adoc[]
