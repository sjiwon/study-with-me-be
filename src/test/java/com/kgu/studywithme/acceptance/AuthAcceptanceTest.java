...
public class AuthAcceptanceTest extends AcceptanceTest {
    ...
    void loginApiFailure() {
        Google_OAuth_로그인을_진행한다(GOOGLE_PROVIDER, REDIRECT_URL)
    ...
    void logoutApi() {
        final String accessToken = OAuth_로그인을_진행하고_AccessToken을_얻는다(GOOGLE_PROVIDER, REDIRECT_URL);
    ...
    void tokenReissueApi() {
        final String refreshToken = OAuth_로그인을_진행하고_RefreshToken을_얻는다(GOOGLE_PROVIDER, REDIRECT_URL);
