...
@DisplayName("Report -> MemberReportApiController 테스트")
class MemberReportApiControllerTest extends ControllerTest {
    ...
    class report {
        ...
        void throwExceptionByPreviousReportIsStillPending() throws Exception {
            ...
            doThrow(StudyWithMeException.type(ReportErrorCode.PREVIOUS_REPORT_IS_STILL_PENDING))
            ...
            // then
            final ReportErrorCode expectedError = ReportErrorCode.PREVIOUS_REPORT_IS_STILL_PENDING;
