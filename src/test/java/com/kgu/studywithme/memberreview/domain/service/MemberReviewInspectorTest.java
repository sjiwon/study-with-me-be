...
public class MemberReviewInspectorTest {
    ...
    void throwExceptionBySelfReviewNotAllowed() {
        assertThatThrownBy(() -> sut.checkReviewerHasEligibilityToReview(memberA, memberA))
    ...
    void throwExceptionByCommonStudyRecordNotFound() {
        ...
        // when - then
        assertThatThrownBy(() -> sut.checkReviewerHasEligibilityToReview(memberA, memberB))
                .isInstanceOf(StudyWithMeException.class)
    ...
    void success() {
        ...
        // when - then
        assertDoesNotThrow(() -> sut.checkReviewerHasEligibilityToReview(memberA, memberB));
